...
const generatedBirdImg = document.querySelector(".GeneratedBird_img");
const generatedBirdName = document.querySelector(".GeneratedBird_name");
...
const CARD_POPUP = document.querySelector(".buttonPopup");
CARD_POPUP.addEventListener("click", function (e) {
...
const disabledButton = document.getElementById("button");
...
const startLevel = (birds) => {  
  ...
  if (level !== 0) {
    levelIndicators[level - 1].classList.toggle("_active");
  }
  ...
  birds.map((bird) => {
    ...
    birdElement.className = "bird__element";
    birdElement.textContent = bird.name;
    birdElement.dataset.id = bird.id;
    birdElement.onclick = answerHandler;
    answer.append(birdElement);

    let birdSpan = document.createElement("span");
    birdSpan.className = "li-btn";
    birdSpan.dataset.id = bird.id;
...
const generateContent = () => {
  ...
  <div class="container__answer">
    <img src="${selectedBird.image}" class="img">
    <div class="container__answer__flex">
      <div class="selectedBirdName">${selectedBird.name}</div>
      <div>${selectedBird.species}</div>
      <audio class='audio' src="${selectedBird.audio}" controls="controls"></audio>    

    </div>
  </div>
    <div class="description">${selectedBird.description}</div>`;
  trueAnswer.innerHTML = containerAnswer;  
};
...
// const nextLevel = () => {
//   const startLEvel = document.getElementById('button')
//     startLEvel.onclick = function(){
...
//   selectedBird = birdsData[0][selectedId - 1];
...
//Вставить сюда №1
// const deletePointer = document.querySelectorAll('.bird__element')
// deletePointer.onclick = null
// deletePointer.disabled = false
// console.log(deletePointer)

// const deletePointer = document.querySelector(".answer")
// deletePointer.classList.add('.delete__pointer')
// console.log(deletePointer)

// const audio = document.querySelector(".trueAudio");
// audio.play();

// generatedBirdImg.src = generatedBird.image;
// generatedBirdName.textContent = generatedBird.name;

// const buttonNextLevel = document.querySelector(".bntNext")
// buttonNextLevel.classList.add(".next") //pointer-events:all
// buttonNextLevel.onclick = () => i++

//вставить сюда №2
// let containerAnswer = document.createElement("div");
// containerAnswer.className = "container__answer"
// trueAnswer.append(containerAnswer)

// let image = document.createElement("img");
// image.src = selectedBird.image;
// image.className = "img";
// containerAnswer.append(image);

// let containerAnswerFlex = document.createElement("div");
// containerAnswerFlex.className = "container__answer__flex"
// containerAnswer.append(containerAnswerFlex)

// let name = document.createElement("div");
// name.textContent = selectedBird.name;
// containerAnswerFlex.append(name);

// let nameSpecies = document.createElement("div");
// nameSpecies.textContent = selectedBird.species;
// containerAnswerFlex.append(nameSpecies);

// let audio = document.createElement("AUDIO");
// audio.src = selectedBird.audio;
// audio.setAttribute("controls", "controls");
// containerAnswerFlex.appendChild(audio);
